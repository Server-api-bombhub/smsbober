...
def main():
    ...
    banner =  f"""{colorama.Fore.LIGHTRED_EX}
            ...
            |      _______    ________   ___    __   __   ___      |
            |     |       \  |__    __| |   \  |  | |  | /  /      |
            |     |  [ ]   |    |  |    |    \ |  | |  |/  /       |
            |     |   ____/     |  |    |  |\ \|  | |     <        |
            |     |  |        __|  |__  |  | \    | |  |\  \       | 
            |     |__|       |________| |__|  \___| |__| \__\      |
            |                  Creat By: AMIRPINK                  |            
            |______________________________________________________|
    """
    print(banner)
    print(f"{colorama.Fore.MAGENTA}Waiting 2 sec ...")
    time.sleep(1) 
    print(f"{colorama.Fore.WHITE}creat by amirpink")
    print(f"{colorama.Fore.WHITE}Rubika id : @amirpink")
    print(f"{colorama.Fore.WHITE}telegram id : @bomb.back")
    print(f"{colorama.Fore.CYAN}Starting ...")
    phone = str(input(Fore.GREEN + "Phone Number Target (+98912......) => "))
    while True:
